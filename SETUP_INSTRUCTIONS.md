...
## 3. Update Paystack Key in Code

Replace the test key in `src/pages/Checkout.tsx` line 189:

```typescript
key: import.meta.env.VITE_PAYSTACK_PUBLIC_KEY || "pk_test_your_actual_key_here",
```
...
That's it! The escrow system will now work with Paystack payments.