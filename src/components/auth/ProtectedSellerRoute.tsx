...
const ProtectedSellerRoute = ({ children }: ProtectedSellerRouteProps) => {
  ...
  // Ignores the returned payment reference - this route just reloads to
  // re-check subscription status, unlike SellerFeatureGuard which confirms
  // the renewal via renewSubscription(paymentReference).
