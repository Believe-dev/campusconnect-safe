// Copied from the design reference's @heroicons/react usage (outline 24 /
// solid 24) rather than added as a dependency — only a handful of icons are
// needed and the project otherwise standardizes on lucide-react.
...
const solidProps: SVGProps<SVGSVGElement> = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  fill: "currentColor",
  "aria-hidden": "true",
...
export const PlusIconSolid = ({ className }: { className?: string }) => (
...
export const MinusIconSolid = ({ className }: { className?: string }) => (
  <svg {...solidProps} className={className}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
// Not part of the heroicons set — kept here anyway since it's the shared
// home for small local icon components (used by the profile menu, which
// otherwise only pulls from lucide-react and this file).
...
export const LearnMoreIcon = ({ className }: { className?: string }) => (
