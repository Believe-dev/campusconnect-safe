                  ...
                  <Dialog open={editing} onOpenChange={setEditing}>
                    ...
                    <DialogContent className="max-w-md max-h-[80vh] overflow-y-auto">
                      ...
                      <div className="space-y-4">
                        ...
                        {/* Phone Number for Sellers - changes go through OTP verification
                            (see the pencil-icon edit button below), not this form, so an
                            unverified number can never silently overwrite a verified one. */}
                        {(profile?.account_type === "seller" ||
                          profile?.account_type === "both") && (
                          <div>
      ...
      >
        <DialogContent className="max-w-md">
          ...
          {phoneOtpStep === "enter_phone" ? (
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="phone_otp_code">6-Digit Code</Label>
                <Input
                  id="phone_otp_code"
                  value={phoneOtpCode}
