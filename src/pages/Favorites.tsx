              ...
              <div>
                ...
                {favorites.length > 0 && (
                  <div className="mt-2 text-xs text-muted-foreground bg-muted/30 p-2 rounded border">
                    📌 Verified sellers' products are prioritized in your
                    favorites
                  </div>
                )}
              </div>
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Start browsing and add products to your favorites to see them
                  here
                </p>
                <Button
                  variant="brand"
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-square overflow-hidden bg-muted">
                      ...
                      {/* Condition Badge */}
                      <Badge
                        className={`absolute top-2 right-2 text-xs px-2 py-1 font-medium shadow-sm ${getConditionColor(
                          product.condition
                        )}`}
                      >
                        ...
                        <div className="flex items-center gap-1 text-xs">
                          <button
                            onClick={(e) => {
                              ...
                              navigate(
                                `/seller/${
                                  product.profiles?.user_id || product.seller_id
                                }`
                              );
                            }}
